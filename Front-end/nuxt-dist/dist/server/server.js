...
/******/ 			var chunk = require("./" + ({"1":"pages/blogs/_slug","2":"pages/blogs/comment-organiser-vos-reception","3":"pages/blogs/index","4":"pages/boutique/checkout","5":"pages/boutique/index","6":"pages/cat/_slug","7":"pages/categories/_slug","8":"pages/conditions-generales-ventes","9":"pages/contact","10":"pages/index","11":"pages/mentions-legales","12":"pages/politique-confidentialite","13":"pages/producteurs/ferme-ekiola","14":"pages/producteurs/ferme-elizaldia","15":"pages/producteurs/fromagerie-aldudes","16":"pages/producteurs/index","17":"pages/producteurs/maison-laborie","18":"pages/strapi/index","19":"pages/traiteur/index"}[chunkId]||chunkId) + ".js");
...
var add = __webpack_require__(5).default
module.exports.__inject__ = function (context) {
  add("35e31164", content, true, context)
};
...
var add = __webpack_require__(5).default
module.exports.__inject__ = function (context) {
  add("3114a8fc", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_TheHeader_vue_vue_type_style_index_0_id_6edbed88_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(26);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_TheHeader_vue_vue_type_style_index_0_id_6edbed88_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_TheHeader_vue_vue_type_style_index_0_id_6edbed88_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_TheHeader_vue_vue_type_style_index_0_id_6edbed88_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_TheHeader_vue_vue_type_style_index_0_id_6edbed88_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_URL_REPLACEMENT_0___ = ___CSS_LOADER_GET_URL_IMPORT___(___CSS_LOADER_URL_IMPORT_0___);
// Module
___CSS_LOADER_EXPORT___.push([module.i, "header[data-v-6edbed88]{position:fixed;width:100%;top:0;justify-content:space-between;z-index:100;transition:all .3s ease-in-out}.top_bar_color[data-v-6edbed88]{background-color:var(--white)}.top_bar_flex[data-v-6edbed88]{display:flex}.block_header[data-v-6edbed88]{display:flex;align-items:center;margin:auto;padding:10px 20px 5px;justify-content:space-between}.logo img[data-v-6edbed88]{width:70px;z-index:100}.cta_header[data-v-6edbed88]{display:none}.menu_mobile[data-v-6edbed88]{position:fixed;top:0;width:100%;padding:30px 15px;bottom:0;left:0;right:0;background-color:var(--black);background-image:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");height:100%;overflow-y:scroll;z-index:2}.top_bar_menu[data-v-6edbed88]{display:flex;justify-content:space-between;align-items:center;padding:0 10px}.menu_mobile .logo_menu img[data-v-6edbed88]{width:80px}.close_menu p[data-v-6edbed88]{background-color:var(--orange);padding:5px 15px;font-family:bodyBold,sans-serif;box-shadow:5px 5px rgba(177,78,12,.274);transform:rotate(-3deg)!important;color:var(--white)!important}.items_menu_mobile_fixed[data-v-6edbed88]{display:flex;flex-flow:column;padding:10% 20px 20px}.items_menu_mobile_fixed p[data-v-6edbed88]{color:var(--white);font-size:14px;font-family:bodyBold,sans-serif;margin-bottom:20px}.cart[data-v-6edbed88]{cursor:pointer;position:relative}.cart p[data-v-6edbed88]{position:absolute;background-color:var(--orange)!important;height:20px;font-size:10px!important;width:20px;top:0;left:15px;border-radius:50%;box-shadow:none!important;display:flex;justify-content:center;align-items:center;transform:rotate(3deg)!important}.cart p[data-v-6edbed88],.items_menu_mobile_fixed a[data-v-6edbed88]{color:var(--white);font-family:bodyBold,sans-serif}.items_menu_mobile_fixed a[data-v-6edbed88]{font-size:20px;text-decoration:none;margin-bottom:5px;margin-top:5px;opacity:0;-webkit-animation:top-data-v-6edbed88 1s forwards;animation:top-data-v-6edbed88 1s forwards}@-webkit-keyframes top-data-v-6edbed88{0%{opacity:0;transform:translateY(20px)}to{opacity:1;transform:translateY(0)}}@keyframes top-data-v-6edbed88{0%{opacity:0;transform:translateY(20px)}to{opacity:1;transform:translateY(0)}}.items_menu_mobile_fixed a[data-v-6edbed88]:nth-child(2){-webkit-animation-delay:.2s;animation-delay:.2s}.items_menu_mobile_fixed a[data-v-6edbed88]:nth-child(3){-webkit-animation-delay:.3s;animation-delay:.3s}.items_menu_mobile_fixed a[data-v-6edbed88]:nth-child(4){-webkit-animation-delay:.4s;animation-delay:.4s}.items_menu_mobile_fixed a[data-v-6edbed88]:nth-child(5){-webkit-animation-delay:.5s;animation-delay:.5s}.items_menu_mobile_fixed a[data-v-6edbed88]:nth-child(6){-webkit-animation-delay:.6s;animation-delay:.6s}hr[data-v-6edbed88]{border:none;width:30px;height:2px;margin:0 20px;border-radius:10px;background-color:var(--white)}.button_contact button[data-v-6edbed88]{margin-top:30px;background-color:var(--orange);padding:12px 48px;margin-left:20px;text-align:center;color:var(--white);font-size:16px;font-family:bodyBold;border:none;cursor:pointer}.sociaux[data-v-6edbed88]{margin:50px 20px}.sociaux img[data-v-6edbed88]{width:30px;margin-right:5px}.sociaux p[data-v-6edbed88]{color:var(--white);font-size:14px;font-family:bodyBold,sans-serif;margin-bottom:20px}.copyright[data-v-6edbed88]{display:flex;position:absolute;justify-content:space-between;bottom:20px;left:30px;right:20px}.copyright p[data-v-6edbed88]{font-size:12px;color:var(--white);font-family:bodyBold,sans-serif}.contact_menu p[data-v-6edbed88]:nth-child(2){margin-top:5px;font-family:body,sans-serif}.legales a[data-v-6edbed88]{color:var(--white)!important;text-decoration:none;font-size:12px;margin:0;padding:0}.items_menu_mobile[data-v-6edbed88]{display:flex;align-items:center;width:150px;justify-content:space-between}.items_menu_mobile .cart[data-v-6edbed88]{position:relative}.items_menu_mobile .cart .number_cart[data-v-6edbed88]{margin-top:-5px;background-color:var(--orange);text-align:center;position:absolute;width:19px;border-radius:50%;height:19px;margin-left:-5px}.items_menu_mobile .cart img[data-v-6edbed88]{width:30px}.items_menu_mobile span[data-v-6edbed88]{width:2px;height:26px;border:none;background-color:var(--black)}.items_menu_mobile p[data-v-6edbed88]{background-color:var(--black);padding:5px 15px;font-family:bodyBold,sans-serif;box-shadow:5px 5px rgba(5,5,5,.274);transform:rotate(-3deg)!important;color:var(--white)!important;font-size:14px}.items_menu_desktop[data-v-6edbed88]{display:none}.nuxt-link-exact-active[data-v-6edbed88]{color:var(--orange)!important;text-decoration:none;font-family:bodyBold,sans-serif}.open-enter-active[data-v-6edbed88]{-webkit-animation:slide-data-v-6edbed88 .3s;animation:slide-data-v-6edbed88 .3s}.open-leave-active[data-v-6edbed88]{-webkit-animation:slideClose-data-v-6edbed88 .3s;animation:slideClose-data-v-6edbed88 .3s}@-webkit-keyframes slide-data-v-6edbed88{0%{transform:translateX(100%)}to{transform:translateX(0)}}@keyframes slide-data-v-6edbed88{0%{transform:translateX(100%)}to{transform:translateX(0)}}@-webkit-keyframes slideClose-data-v-6edbed88{0%{transform:translateX(0)}to{transform:translateX(100%)}}@keyframes slideClose-data-v-6edbed88{0%{transform:translateX(0)}to{transform:translateX(100%)}}@media screen and (min-width:768px){.menu_mobile[data-v-6edbed88]{width:50%;right:0}.open-enter-active[data-v-6edbed88]{-webkit-animation:slide-data-v-6edbed88 .3s;animation:slide-data-v-6edbed88 .3s}.open-leave-active[data-v-6edbed88]{-webkit-animation:slideClose-data-v-6edbed88 .3s;animation:slideClose-data-v-6edbed88 .3s}@-webkit-keyframes slide-data-v-6edbed88{0%{transform:translateX(-100%)}to{transform:translateX(0)}}@keyframes slide-data-v-6edbed88{0%{transform:translateX(-100%)}to{transform:translateX(0)}}@-webkit-keyframes slideClose-data-v-6edbed88{0%{transform:translateX(0)}to{transform:translateX(-100%)}}@keyframes slideClose-data-v-6edbed88{0%{transform:translateX(0)}to{transform:translateX(-100%)}}}@media screen and (min-width:1081px){header[data-v-6edbed88]{width:100%}.cart[data-v-6edbed88]{cursor:pointer}.menu_mobile[data-v-6edbed88]{display:none}.cta_header[data-v-6edbed88]{width:300px;justify-content:space-between;align-items:center}.cta_header span[data-v-6edbed88]{width:2px;height:26px;border:none;background-color:var(--black)}.cta_header .cart img[data-v-6edbed88]{width:30px}.nuxt-link-exact-active[data-v-6edbed88]{background-color:var(--black);padding:5px 10px;box-shadow:5px 5px rgba(5,5,5,.274);transform:rotate(-3deg)!important;color:var(--white)!important;z-index:3!important}.header_left[data-v-6edbed88]{display:flex;justify-content:flex-start;align-items:center}.logo img[data-v-6edbed88]{width:70px}.items_menu_desktop[data-v-6edbed88]{margin-left:50px;display:flex;align-items:center}.items_menu_mobile[data-v-6edbed88]{display:none}.items_menu_desktop a[data-v-6edbed88]{margin-right:30px;font-size:13px;font-family:bodyBold;text-decoration:none;color:#585858;transition:all .3s}.cta_header[data-v-6edbed88]{display:flex}.cta_header button[data-v-6edbed88]{background-color:var(--orange);padding:12px 26px;color:var(--white);font-size:13px;font-family:bodyBold;border:none;cursor:pointer}.items_menu_desktop a[data-v-6edbed88]:hover{color:var(--orange)!important}}@media screen and (min-width:1200px){.block_header[data-v-6edbed88]{max-width:1200px;margin:auto;padding:20px 0}}@media screen and (min-width:1400px){.block_header[data-v-6edbed88]{max-width:1400px;margin:auto;padding:20px 0}}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_TheFooter_vue_vue_type_style_index_0_id_150a1066_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(27);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_TheFooter_vue_vue_type_style_index_0_id_150a1066_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_TheFooter_vue_vue_type_style_index_0_id_150a1066_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_TheFooter_vue_vue_type_style_index_0_id_150a1066_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_TheFooter_vue_vue_type_style_index_0_id_150a1066_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, "a[data-v-150a1066]{text-decoration:none;color:var(--white)}.footer[data-v-150a1066]{background-color:var(--black);padding:20px 15px;display:flex;flex-flow:column}.content_footer[data-v-150a1066]{color:var(--white)}.logo_footer img[data-v-150a1066]{width:100px}.logo_footer p[data-v-150a1066]{width:230px;color:#999;line-height:26px;font-size:14px;margin:20px 0}.hr_items[data-v-150a1066]{width:100%;border:none;background-color:silver;height:1px;border-radius:4px}.items_footer[data-v-150a1066]{display:flex;flex-flow:row wrap;justify-content:flex-start;margin-top:30px}.item[data-v-150a1066]{width:160px;margin-bottom:50px}.title_item p[data-v-150a1066]{font-size:14px;text-transform:uppercase;font-family:bodyBold,sans-serif}.content_item[data-v-150a1066]{font-size:14px;margin-top:10px}.content_item p[data-v-150a1066]{margin-top:10px;margin-bottom:10px;transition:all .3s}.content_item p[data-v-150a1066]:hover{opacity:1}.hr_copyright[data-v-150a1066]{width:100%;border:none;background-color:silver;height:1px;border-radius:4px}.picto[data-v-150a1066]{display:flex;margin-bottom:20px}.picto img[data-v-150a1066]{width:40px;margin-right:5px}.infos_copyright[data-v-150a1066]{color:var(--white);display:flex;flex-flow:column;margin:20px 0}.icons_sociaux_mobile[data-v-150a1066]{display:flex;margin-bottom:10px}.icons_sociaux_mobile img[data-v-150a1066]{width:30px;margin-right:10px}.icons_sociaux_desktop[data-v-150a1066]{display:none}.infos_copyright p[data-v-150a1066]{font-size:14px;margin-bottom:10px}@media screen and (min-width:768px){.footer[data-v-150a1066]{padding:50px 0 0}.item[data-v-150a1066]{width:220px}}@media screen and (min-width:1024px){.footer[data-v-150a1066]{padding:80px 0 20px}.picto_bancaire[data-v-150a1066]{display:flex;justify-content:space-between}.icons_sociaux_desktop[data-v-150a1066]{display:flex}.icons_sociaux_desktop img[data-v-150a1066]{width:35px;margin-right:10px}.content_footer[data-v-150a1066]{display:flex;flex-flow:row wrap;justify-content:flex-start}.hr_items[data-v-150a1066]{display:none}.logo_footer[data-v-150a1066]{width:250px}.icons_sociaux_mobile[data-v-150a1066]{display:none}.item[data-v-150a1066]{width:190px}.infos_copyright[data-v-150a1066]{display:flex;flex-flow:row wrap;justify-content:space-between}}@media screen and (min-width:1200px){.footer[data-v-150a1066]{padding:50px 0 0}.bloc_footer[data-v-150a1066]{max-width:1800px;margin:auto}.item[data-v-150a1066]{width:300px}}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
async function setContext(app, context) {
  ...
  if (!app.context) {
    app.context = {
      ...
      env: {
        "strapiBaseUri": "http://localhost:7878"
      }
    }; // Only set once
...
const _723f10fd = () => interopDefault(__webpack_require__.e(/* import() | pages/blogs/index */ 3).then(__webpack_require__.bind(null, 258)));

const _4ac125ce = () => interopDefault(__webpack_require__.e(/* import() | pages/boutique/index */ 5).then(__webpack_require__.bind(null, 259)));

const _6e61d050 = () => interopDefault(__webpack_require__.e(/* import() | pages/conditions-generales-ventes */ 8).then(__webpack_require__.bind(null, 260)));

const _1221856e = () => interopDefault(__webpack_require__.e(/* import() | pages/contact */ 9).then(__webpack_require__.bind(null, 261)));

const _6d8514ca = () => interopDefault(__webpack_require__.e(/* import() | pages/mentions-legales */ 11).then(__webpack_require__.bind(null, 262)));

const _f403e6c4 = () => interopDefault(__webpack_require__.e(/* import() | pages/politique-confidentialite */ 12).then(__webpack_require__.bind(null, 263)));

const _715ade68 = () => interopDefault(__webpack_require__.e(/* import() | pages/producteurs/index */ 16).then(__webpack_require__.bind(null, 255)));

const _5c3ac39a = () => interopDefault(__webpack_require__.e(/* import() | pages/strapi/index */ 18).then(__webpack_require__.bind(null, 254)));

const _ada3a144 = () => interopDefault(__webpack_require__.e(/* import() | pages/traiteur/index */ 19).then(__webpack_require__.bind(null, 252)));

const _7c6386f4 = () => interopDefault(__webpack_require__.e(/* import() | pages/blogs/comment-organiser-vos-reception */ 2).then(__webpack_require__.bind(null, 264)));

const _ed97020c = () => interopDefault(__webpack_require__.e(/* import() | pages/boutique/checkout */ 4).then(__webpack_require__.bind(null, 256)));

const _4c58a6d9 = () => interopDefault(__webpack_require__.e(/* import() | pages/producteurs/ferme-ekiola */ 13).then(__webpack_require__.bind(null, 265)));

const _30465b71 = () => interopDefault(__webpack_require__.e(/* import() | pages/producteurs/ferme-elizaldia */ 14).then(__webpack_require__.bind(null, 266)));

const _67022118 = () => interopDefault(__webpack_require__.e(/* import() | pages/producteurs/fromagerie-aldudes */ 15).then(__webpack_require__.bind(null, 267)));

const _1fe17812 = () => interopDefault(__webpack_require__.e(/* import() | pages/producteurs/maison-laborie */ 17).then(__webpack_require__.bind(null, 268)));

const _70886fb5 = () => interopDefault(__webpack_require__.e(/* import() | pages/blogs/_slug */ 1).then(__webpack_require__.bind(null, 257)));

const _587b887a = () => interopDefault(__webpack_require__.e(/* import() | pages/cat/_slug */ 6).then(__webpack_require__.bind(null, 269)));

const _7f2af57e = () => interopDefault(__webpack_require__.e(/* import() | pages/categories/_slug */ 7).then(__webpack_require__.bind(null, 270)));

const _347c093b = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 10).then(__webpack_require__.bind(null, 253)));
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./components/default/TheHeader.vue?vue&type=template&id=6edbed88&scoped=true&
var TheHeadervue_type_template_id_6edbed88_scoped_true_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<header class=\"top_bar_color\" data-v-6edbed88>","</header>",[_vm._ssrNode("<div class=\"block_header\" data-v-6edbed88>","</div>",[_vm._ssrNode("<div class=\"header_left\" data-v-6edbed88>","</div>",[_vm._ssrNode("<a href=\"/\" data-v-6edbed88><div class=\"logo\" data-v-6edbed88><img"+(_vm._ssrAttr("src",__webpack_require__(16)))+" alt data-v-6edbed88></div></a> "),_vm._ssrNode("<div class=\"items_menu_desktop\" data-v-6edbed88>","</div>",[_c('nuxt-link',{class:{ items_menu_scroll: _vm.scrollPosition > 100 },attrs:{"to":"/"}},[_vm._v("Accueil")]),_vm._ssrNode(" "),_c('nuxt-link',{class:{ items_menu_scroll: _vm.scrollPosition > 100 },attrs:{"to":"/traiteur"}},[_vm._v("Traiteur")]),_vm._ssrNode(" "),_c('nuxt-link',{class:{ items_menu_scroll: _vm.scrollPosition > 100 },attrs:{"to":"/producteurs"}},[_vm._v("Producteurs")]),_vm._ssrNode(" "),_c('nuxt-link',{class:{ items_menu_scroll: _vm.scrollPosition > 100 },attrs:{"to":"/blogs"}},[_vm._v("Blog")]),_vm._ssrNode(" "),_c('nuxt-link',{class:{ items_menu_scroll: _vm.scrollPosition > 100 },attrs:{"to":"/boutique"}},[_vm._v("Boutique")])],2)],2),_vm._ssrNode(" <div class=\"header_right\" data-v-6edbed88><div class=\"items_menu_mobile\" data-v-6edbed88><div class=\"cart\" data-v-6edbed88><img"+(_vm._ssrAttr("src",__webpack_require__(23)))+" alt data-v-6edbed88> "+((_vm.carts.length > 0)?("<p data-v-6edbed88>"+_vm._ssrEscape(_vm._s(_vm.carts.length))+"</p>"):"<!---->")+"</div> <span data-v-6edbed88></span> <p data-v-6edbed88>Menu</p></div> <div class=\"cta_header\" data-v-6edbed88><div class=\"cart\" data-v-6edbed88><img"+(_vm._ssrAttr("src",__webpack_require__(23)))+" alt data-v-6edbed88> "+((_vm.carts.length > 0)?("<p data-v-6edbed88>"+_vm._ssrEscape(_vm._s(_vm.carts.length))+"</p>"):"<!---->")+"</div> <span data-v-6edbed88></span> <button data-v-6edbed88>Obtenir mon devis</button></div></div> "),_c('transition',{attrs:{"name":"open","appear":""}},[(_vm.openMenu)?_c('div',{staticClass:"menu_mobile",on:{"click":function($event){_vm.cart = false}}},[_c('div',{staticClass:"top_bar_menu"},[_c('div',{staticClass:"logo_menu"},[_c('img',{attrs:{"src":__webpack_require__(16),"alt":""}})]),_vm._v(" "),_c('div',{staticClass:"close_menu"},[_c('p',{on:{"click":function($event){_vm.openMenu = !_vm.openMenu}}},[_vm._v("Retour")])])]),_vm._v(" "),_c('div',{staticClass:"items_menu_mobile_fixed",on:{"click":function($event){_vm.openMenu = !_vm.openMenu}}},[_c('p',[_vm._v("MENU")]),_vm._v(" "),_c('nuxt-link',{attrs:{"to":"/"}},[_vm._v("Accueil")]),_vm._v(" "),_c('nuxt-link',{attrs:{"to":"/traiteur"}},[_vm._v("Traiteur")]),_vm._v(" "),_c('nuxt-link',{attrs:{"to":"/producteurs"}},[_vm._v("Producteurs")]),_vm._v(" "),_c('nuxt-link',{attrs:{"to":"/blogs"}},[_vm._v("Blog")]),_vm._v(" "),_c('nuxt-link',{attrs:{"to":"/boutique"}},[_vm._v("Boutique")])],1),_vm._v(" "),_c('hr'),_vm._v(" "),_c('div',{staticClass:"button_contact"},[_c('button',{on:{"click":function($event){_vm.devis = !_vm.devis, _vm.openMenu = !_vm.openMenu}}},[_vm._v("Obtenir mon devis")])]),_vm._v(" "),_c('div',{staticClass:"sociaux"},[_c('p',[_vm._v("NOUS SUIVRE")]),_vm._v(" "),_c('div',{staticClass:"icons_sociaux"},[_c('img',{attrs:{"src":__webpack_require__(11),"alt":""}}),_vm._v(" "),_c('img',{attrs:{"src":__webpack_require__(10),"alt":""}}),_vm._v(" "),_c('img',{attrs:{"src":__webpack_require__(12),"alt":""}})])]),_vm._v(" "),_c('div',{staticClass:"copyright"},[_c('div',{staticClass:"contact_menu"},[_c('p',[_vm._v("+33 (0)7 54 82 76 76")]),_vm._v(" "),_c('p',[_vm._v("contact@my-terroir.fr")])]),_vm._v(" "),_c('div',{staticClass:"legales"},[_c('p',[_vm._v("©My Terroir 2021")]),_vm._v(" "),_c('nuxt-link',{attrs:{"to":"/mentions-legales"}},[_vm._v("Mentions légales")])],1)])]):_vm._e()])],2)]),_vm._ssrNode(" "),(_vm.cart)?_c('Cart',{attrs:{"cart":_vm.cart}}):_vm._e(),_vm._ssrNode(" "),(_vm.devis)?_c('devisHeader',{attrs:{"devis":_vm.devis}}):_vm._e()],2)}
var TheHeadervue_type_template_id_6edbed88_scoped_true_staticRenderFns = []


// CONCATENATED MODULE: ./components/default/TheHeader.vue?vue&type=template&id=6edbed88&scoped=true&
...
var TheHeader_component = Object(componentNormalizer["a" /* default */])(
  ...
  TheHeadervue_type_template_id_6edbed88_scoped_true_render,
  TheHeadervue_type_template_id_6edbed88_scoped_true_staticRenderFns,
  false,
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./components/default/TheFooter.vue?vue&type=template&id=150a1066&scoped=true&
var TheFootervue_type_template_id_150a1066_scoped_true_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('footer',{staticClass:"footer"},[_vm._ssrNode("<div class=\"bloc_footer\" data-v-150a1066>","</div>",[_vm._ssrNode("<div class=\"content_footer\" data-v-150a1066>","</div>",[_vm._ssrNode("<div class=\"logo_footer\" data-v-150a1066><img"+(_vm._ssrAttr("src",__webpack_require__(16)))+" alt data-v-150a1066> <p data-v-150a1066>\n          Distributeur de produits authentiques pour professionnels et\n          particuliers .\n        </p> <div class=\"icons_sociaux_mobile\" data-v-150a1066><a href=\"https://fr-fr.facebook.com/myterroir/\" target=\"_blank\" data-v-150a1066><img"+(_vm._ssrAttr("src",__webpack_require__(11)))+" alt data-v-150a1066></a> <a href=\"https://www.instagram.com/myterroir/?hl=fr\" target=\"_blank\" data-v-150a1066><img"+(_vm._ssrAttr("src",__webpack_require__(10)))+" alt data-v-150a1066></a> <a href=\"https://www.linkedin.com/company/myterroir/?originalSubdomain=fr\" target=\"_blank\" data-v-150a1066><img"+(_vm._ssrAttr("src",__webpack_require__(12)))+" alt data-v-150a1066></a></div></div> <hr class=\"hr_items\" data-v-150a1066> "),_vm._ssrNode("<div class=\"items_footer\" data-v-150a1066>","</div>",[_vm._ssrNode("<div class=\"item\" data-v-150a1066>","</div>",[_vm._ssrNode("<div class=\"title_item\" data-v-150a1066><p data-v-150a1066>Plan du site</p></div> "),_vm._ssrNode("<div class=\"content_item\" data-v-150a1066>","</div>",[_c('nuxt-link',{attrs:{"to":"/traiteur"}},[_c('p',[_vm._v("Traiteur")])]),_vm._ssrNode(" "),_c('nuxt-link',{attrs:{"to":"/producteurs"}},[_c('p',[_vm._v("Producteurs")])]),_vm._ssrNode(" "),_c('nuxt-link',{attrs:{"to":"/blog"}},[_c('p',[_vm._v("Blog")])]),_vm._ssrNode(" "),_c('nuxt-link',{attrs:{"to":"/boutique"}},[_c('p',[_vm._v("Boutique")])])],2)],2),_vm._ssrNode(" <div class=\"item\" data-v-150a1066><div class=\"title_item\" data-v-150a1066><p data-v-150a1066>Contact</p></div> <div class=\"content_item\" data-v-150a1066><a href=\"tel:+33754827676\" data-v-150a1066><p data-v-150a1066>+33 (0)7 54 82 76 76</p></a> <a href=\"mailto:contact@my-terroir.fr?subject=Demande de contact site web.\" data-v-150a1066><p data-v-150a1066>contact@my-terroir.fr</p></a> <a href=\"https://ul.waze.com/ul?place=Ei00ODIgUnVlIGR1IENvdXJkb3VuZXksIDMzMTQwIENhZGF1amFjLCBGcmFuY2UiURJPCjQKMgljQ41WnSFVDREmH0OhPx9VCRoeCxDuwe6hARoUChIJ7WD-BTghVQ0R0IivkRplBhwMEOIDKhQKEglz1V5xeCFVDRGm2dFzEAWfJg&ll=44.73625560%2C-0.53585240&navigate=yes&utm_campaign=waze_website&utm_source=waze_website&utm_medium=lm_share_location\" data-v-150a1066><p data-v-150a1066>\n                482 rue du Courdonney <br data-v-150a1066>\n                33140 Cadaujac\n              </p></a> <p data-v-150a1066>du Lundi au Vendredi <br data-v-150a1066> de 9h à 18h</p></div></div> "),_vm._ssrNode("<div class=\"item\" data-v-150a1066>","</div>",[_vm._ssrNode("<div class=\"title_item\" data-v-150a1066><p data-v-150a1066>Légales</p></div> "),_vm._ssrNode("<div class=\"content_item\" data-v-150a1066>","</div>",[_c('nuxt-link',{attrs:{"to":"/mentions-legales"}},[_c('p',[_vm._v("Mentions légales")])]),_vm._ssrNode(" "),_c('nuxt-link',{attrs:{"to":"/politique-confidentialite"}},[_c('p',[_vm._v("Politique de confidentialité")])]),_vm._ssrNode(" "),_c('nuxt-link',{attrs:{"to":"/conditions-generales-ventes"}},[_c('p',[_vm._v("Conditions générales de ventes")])])],2)],2)],2)],2),_vm._ssrNode(" <div class=\"copyright_footer\" data-v-150a1066><div class=\"picto_bancaire\" data-v-150a1066><div class=\"picto\" data-v-150a1066><img"+(_vm._ssrAttr("src",__webpack_require__(57)))+" alt data-v-150a1066> <img"+(_vm._ssrAttr("src",__webpack_require__(58)))+" alt data-v-150a1066> <img"+(_vm._ssrAttr("src",__webpack_require__(59)))+" alt data-v-150a1066></div> <div class=\"icons_sociaux_desktop\" data-v-150a1066><a href=\"https://fr-fr.facebook.com/myterroir/\" target=\"_blank\" data-v-150a1066><img"+(_vm._ssrAttr("src",__webpack_require__(11)))+" alt data-v-150a1066></a> <a href=\"https://www.instagram.com/myterroir/?hl=fr\" target=\"_blank\" data-v-150a1066><img"+(_vm._ssrAttr("src",__webpack_require__(10)))+" alt data-v-150a1066></a> <a href=\"https://www.linkedin.com/company/myterroir/?originalSubdomain=fr\" target=\"_blank\" data-v-150a1066><img"+(_vm._ssrAttr("src",__webpack_require__(12)))+" alt data-v-150a1066></a></div></div> <hr class=\"hr_copyright\" data-v-150a1066> <div class=\"infos_copyright\" data-v-150a1066><p data-v-150a1066>©2021 - My Terroir</p> <p data-v-150a1066>Charte graphique <a href=\"https://noemiepulido-graphiste.com\" target=\"_blank\" data-v-150a1066>Noémie PULIDO</a>. Développement <a href=\"https://rouxnicolas.fr\" target=\"_blank\" data-v-150a1066> Nicolas ROUX</a>.</p></div></div>")],2)])}
var TheFootervue_type_template_id_150a1066_scoped_true_staticRenderFns = []


// CONCATENATED MODULE: ./components/default/TheFooter.vue?vue&type=template&id=150a1066&scoped=true&
...
var TheFooter_component = Object(componentNormalizer["a" /* default */])(
  ...
  TheFootervue_type_template_id_150a1066_scoped_true_render,
  TheFootervue_type_template_id_150a1066_scoped_true_staticRenderFns,
  false,
