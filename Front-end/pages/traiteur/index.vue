<template>
  <div>
    ...
    <transition name="open" appear>
      ...
      <div class="details" v-if="mariage">
        <div class="card_name">
          <div class="title_name_card">
            <span></span>
            <h3>Mariages</h3>
          </div>
          <p @click="mariage = !mariage">Retour</p>
        </div>
        <div class="img_card">
          <div class="arrow">
            <div class="arrowPrev" @click="Prev">
          ...
          >
            <img src="~assets/img/png/mariage.jpg" alt="" />
            <img src="~assets/img/png/mariage_1.jpg" alt="" />
            <img src="~assets/img/png/mariage_2.jpg" alt="" />
            <img src="~assets/img/png/mariage_3.jpg" alt="" />
          </VueSlickCarousel>
        </div>
        <div class="content_card_intro">
          <p>
        ...
        <div class="group">
          ...
          <div class="content_group" v-if="apero">
            <p>
              ...
              maison Raymond d'Artigues. <br />
              Nem au confit de canard de la maison Duperié. <br />
              Blinis de truite fumée de la ferme du Ciron et crème citronnée à
              l'aneth. <br />
              Navette jambon truffé et gouda fermier à la truffe. <br />
          ...
          <div class="content_group" v-if="bBasque">
            <p>
              ...
              mois <br />
              Accompagnement pan con tomate & huile d'olive BIO <br />
              Plateau d'huîtres de la Canfouine au Canon (Cap Ferret)
            </p>
          </div>
          <div class="title_group" @click="bFrance = !bFrance">
            <p>Animation brasero</p>
            <div class="price_content">
              <p class="plus" :class="{ plus_open: bFrance }">+</p>
            </div>
          </div>
          <div class="content_group" v-if="bFrance">
            <p>
              Gambas flambées au pastis et persillade. <br />
              Araignées de porc marinées de la ferme Elizaldia. <br />
        ...
        <div class="group">
          <div class="title_group" @click="cBasque = !cBasque">
            <p>Diner assis (plat à partager sur table au choix)</p>
            <div class="price_content">
              <p class="plus" :class="{ plus_open: cBasque }">+</p>
            </div>
          </div>
          <div class="content_group" v-if="cBasque">
            <p>
              T-Bone d’Angus de la ferme des Herbages Gascon. <br />
              Picanha de bœuf de Galice maturé 21 jours. <br />
              Magret de canard de la maison Raymond d’Artigues. <br />
              Garnitures : pommes de terre de Noirmoutier confites et légumes du
              soleil rôtis.
            </p>
          </div>
          <div class="title_group" @click="cFrance = !cFrance">
            <p>Plateaux de fromages affinés</p>
            <div class="price_content">
              <p class="plus" :class="{ plus_open: cFrance }">+</p>
            </div>
          </div>
          <div class="content_group" v-if="cFrance">
            <p>
              Comté 18 mois du Fort Saint Antoine Marcel Petite <br />
              Ossau Iraty ferme Ekiola <br />
              Mobier lait cru fromagerie Monin <br />
...
import devisMariage from "../../components/traiteur/devisMariage";
    ...
    meta: [
      {
        ...
        content:
          "Choisissez un traiteur sur Bordeaux pas comme les autres qui vous propose une sélection de produits de qualité dénichée chez des producteurs artisanaux.",
        keywords:
          "Traiteur, Bordeaux, Traiteur-Bordeaux, Produits de terroir, charcuterie, charcuteries, fromage, fromages, viandes, viande, brasero, plancha, mariages, cocktails, buffets, repas",
      },
    ],
  },
  components: {
