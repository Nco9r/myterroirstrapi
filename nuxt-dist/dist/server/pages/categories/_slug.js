...
module.exports.__inject__ = function (context) {
  add("85f1007c", content, true, context)
};
...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_slug_vue_vue_type_style_index_0_id_43d5b88a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(129);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_slug_vue_vue_type_style_index_0_id_43d5b88a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_slug_vue_vue_type_style_index_0_id_43d5b88a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_slug_vue_vue_type_style_index_0_id_43d5b88a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_slug_vue_vue_type_style_index_0_id_43d5b88a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".nuxt-link-active[data-v-43d5b88a]{border-bottom:2px solid var(--orange);transform:translateY(31px);color:var(--orange)!important;font-family:bodyBold,sans-serif}html[data-v-43d5b88a]{overflow:visible!important}.title_section p[data-v-43d5b88a]:nth-child(2){padding:0 15px;font-family:bodyBold,sans-serif;color:var(--black)}.box_categories[data-v-43d5b88a]{display:flex;flex-flow:row nowrap;overflow:scroll;padding:5px 15px;margin-top:50px}.categorie_flex[data-v-43d5b88a]{flex-flow:row;justify-content:flex-start}.categorie_flex a[data-v-43d5b88a]{color:var(--Body)}.categorie_flex a[data-v-43d5b88a],.content_categorie a p[data-v-43d5b88a]{font-size:14px;margin-left:20px}.categories_blog[data-v-43d5b88a]{padding:0;margin-top:70px;display:flex;flex-flow:row wrap}.categorie_flex[data-v-43d5b88a]{display:flex;flex-flow:row wrap;padding:10px 0;align-items:center;justify-content:center}.content_categorie[data-v-43d5b88a]{margin-top:-15px;margin-bottom:10px}.title_categorie[data-v-43d5b88a]{position:relative}.title_categorie p[data-v-43d5b88a]{font-family:bodyBold;color:var(--orange);font-size:18px;width:100px;position:relative}.item_categorie[data-v-43d5b88a]{display:flex;flex-flow:column;justify-content:center;align-items:center;cursor:pointer}.item_categorie p[data-v-43d5b88a]{font-family:bodyBold,sans-serif;font-size:14px;margin-right:10px;border:1px solid #ddd;padding:10px 35px;text-align:center}.active_categorie p[data-v-43d5b88a]{background-color:var(--orange);border:none;color:var(--white);font-family:bodyBold!important}.actualites[data-v-43d5b88a]{background-color:var(--gray);padding-bottom:30px}a[data-v-43d5b88a]{text-decoration:none}.section_tiret[data-v-43d5b88a]{width:70%;height:1px;color:var(--black);background-color:#c2c2c2;display:block;border:none;margin:15px;padding:0 15px}.section_tiret[data-v-43d5b88a]:after{width:4.5rem;position:absolute;transform:translateY(-50%);display:block;content:\"\";height:.5rem;background:var(--orange)}.title_section[data-v-43d5b88a]{padding-top:30px}.title_section h2[data-v-43d5b88a]{padding:5px 15px;margin-bottom:5px;font-size:24px;line-height:38px;color:var(--black)}.box_cards[data-v-43d5b88a]{display:flex;flex-flow:row wrap;margin-top:20px;margin-left:15px;justify-content:flex-start}.card[data-v-43d5b88a]{width:330px;margin:auto auto 30px;padding-bottom:10px;background-color:var(--white)}.card img[data-v-43d5b88a]{width:100%;-o-object-fit:cover;object-fit:cover;height:200px}.infos_card[data-v-43d5b88a]{display:flex;justify-content:space-between;align-items:center;padding:10px 20px}.infos_card p[data-v-43d5b88a]:first-child{color:var(--white);padding:5px 25px;font-family:bodyBold,sans-serif;background-color:var(--orange)}.infos_card p[data-v-43d5b88a]:nth-child(2){color:var(--orange);font-family:bodyBold,sans-serif}.infos_card p[data-v-43d5b88a]{font-size:12px}.title_card[data-v-43d5b88a]{display:flex;flex-flow:column-reverse;padding:3px 20px 10px}.title_card hr[data-v-43d5b88a]{border:none;width:20px;background-color:var(--orange);height:2px;margin-top:10px;border-radius:4px;margin-right:5px}.title_card p[data-v-43d5b88a]{font-size:18px;font-family:bodyBold,sans-serif;color:var(--black)}.content_card p[data-v-43d5b88a]{padding:2px 20px 10px;font-size:13px;overflow:hidden;display:-webkit-box;-webkit-line-clamp:5;-webkit-box-orient:vertical;line-height:24px;color:var(--black)}.cta_actualites button[data-v-43d5b88a]{background-color:var(--orange);padding:10px 48px;display:flex;margin:40px auto 10px;color:var(--white);cursor:pointer;font-size:16px;font-family:bodyBold;border:none;transition:all .3s;box-shadow:5px 5px rgba(177,78,12,.274)}.cta_actualites button[data-v-43d5b88a]:hover{box-shadow:5px 5px rgba(0,0,0,.274);background-color:var(--black)}.cta_card[data-v-43d5b88a]{display:flex;padding:0 20px 10px;justify-content:flex-start}.cta_card a[data-v-43d5b88a]{font-size:14px;text-decoration:none;color:var(--orange);font-family:bodyBold,sans-serif}@media screen and (min-width:1024px){.box_blog[data-v-43d5b88a]{max-width:900px;margin:auto}.title_section h2[data-v-43d5b88a]{font-size:28px;background-size:100%;width:600px;height:100px;margin-left:50px;margin-bottom:90px}.card[data-v-43d5b88a]{margin-right:30px;width:400px}}@media screen and (min-width:1200px){.categories_blog[data-v-43d5b88a]{max-width:1400px;margin:670px auto 70px;display:flex;flex-flow:wrap;justify-content:space-between;align-items:center}}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/categories/_slug.vue?vue&type=template&id=43d5b88a&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('main',[_c('blogFirst',{attrs:{"blogsf":_vm.blogsf}}),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"categories_blog\" data-v-43d5b88a>","</div>",[_vm._ssrNode("<hr data-v-43d5b88a> <div class=\"title_categorie\" data-v-43d5b88a><p data-v-43d5b88a>Catégories</p></div> "),_vm._ssrNode("<div class=\"categorie_flex\" data-v-43d5b88a>","</div>",_vm._l((_vm.categoriesblogs),function(categorie){return _vm._ssrNode("<div class=\"content_categorie\" data-v-43d5b88a>","</div>",[_c('nuxt-link',{attrs:{"to":{ name: 'categories-slug', params: { slug: categorie.slug } }}},[_c('p',[_vm._v(_vm._s(categorie.name))])])],1)}),0),_vm._ssrNode(" <hr data-v-43d5b88a>")],2),_vm._ssrNode(" "),_c('blog',{attrs:{"blogs":_vm.blogs}}),_vm._ssrNode(" "),_c('Newsletter')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/categories/_slug.vue?vue&type=template&id=43d5b88a&scoped=true&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/categories/_slug.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var _slugvue_type_script_lang_js_ = ({
  async asyncData({
    ...
    const matchingCategories = await $strapi.find('blogcategories', {
      slug: params.slug
    });
    return {
      ...
      blogs: await $strapi.find('blogs?_start=2', {
        'blogcategory.slug': params.slug
      })
    };
  },
  ...
  data() {
    return {
      ...
      fromages: false,
      charcuterie: false,
      apiUrl: "https://admin-myterroir.fr/"
    };
  },
